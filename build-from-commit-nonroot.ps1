...
# Usage: .\build-from-commit-nonroot.ps1
# Optional: $env:DOCKER_HOST="tcp://remote-host:2375"; .\build-from-commit-nonroot.ps1
...
Write-Host "🐳 Building & pushing non-root Docker image (buildx):" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "📦 Non-root images available at:" -ForegroundColor Cyan
Write-Host "   - $IMAGE_TAG"
Write-Host "   - $LATEST_TAG"
